...
.DESCRIPTION
    This script builds the argo-web Docker image in minikube's Docker environment
...
Write-Host "   kubectl get pods -n argo-web" -ForegroundColor Gray
Write-Host ""
Write-Host "3. Access the application:" -ForegroundColor White
Write-Host "   minikube service argo-web-service -n argo-web" -ForegroundColor Gray
Write-Host ""
